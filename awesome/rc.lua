...
for s = 1, screen.count() do
    ...
    tags[s] = awful.tag({ "A", 2, "C", 4, "E", 6, "G", 8, "I" }, s, {layouts[2], layouts[2], layouts[2], layouts[2], layouts[10], layouts[2], layouts[2], layouts[2], layouts[2]})
end
-- }}}
...
globalkeys = awful.util.table.join(
    ...
    -- awful.key({ modkey, "Shift"   }, "Return", function () awful.util.spawn(terminal1) end),
